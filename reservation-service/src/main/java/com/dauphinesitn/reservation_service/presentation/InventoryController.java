...
public class InventoryController {
    ...
    public ResponseEntity<InventoryDTO> getInventoryByFlightId(UUID flightId) {
    ...
    public ResponseEntity<InventoryDTO> updateInventory(UUID flightId, @RequestBody InventoryDTO inventoryDTO) {
        Inventory updatedInventory = inventoryService.updateInventory(flightId, inventoryDTO);
